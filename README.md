...
- **JWT authentication** — stateless auth with token blacklisting on logout
...
- **Feed with filters** — search by keyword, category, and price range
...
| Method | Endpoint | Description |
|---|---|---|
| GET | `/api/listings` | Paginated feed (excludes own listings) |
...
### Category Values
`ELECTRONICS`, `CLOTHING`, `HOME_AND_GARDEN`, `AUTO`, `SPORTS`, `BOOKS`, `GAMES`, `OTHER`
